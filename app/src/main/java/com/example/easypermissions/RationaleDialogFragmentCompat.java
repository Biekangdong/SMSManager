...
public class RationaleDialogFragmentCompat extends AppCompatDialogFragment {
    ...
    private pub.devrel.easypermissions.EasyPermissions.PermissionCallbacks permissionCallbacks;
    ...
    public void onAttach(Context context) {
        ...
        if (getParentFragment() != null && getParentFragment() instanceof pub.devrel.easypermissions.EasyPermissions.PermissionCallbacks) {
            permissionCallbacks = (pub.devrel.easypermissions.EasyPermissions.PermissionCallbacks) getParentFragment();
        } else if (context instanceof pub.devrel.easypermissions.EasyPermissions.PermissionCallbacks) {
            permissionCallbacks = (pub.devrel.easypermissions.EasyPermissions.PermissionCallbacks) context;
        }
    }
