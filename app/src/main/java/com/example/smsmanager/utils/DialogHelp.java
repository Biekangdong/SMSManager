...
public class DialogHelp {
    ...
    public static AlertDialog.Builder getDialog(Context context) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.custom_alertDialog);
        return builder;
    }
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, String tip, String 去设置, String 取消, DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder builder = getDialog(context);
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, View view, DialogInterface.OnClickListener onOkClickListener, DialogInterface.OnClickListener onCancleClickListener) {
        AlertDialog.Builder builder = getDialog(context);
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, View view, DialogInterface.OnClickListener onOkClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setView(view);
        builder.setPositiveButton("确定", onOkClickListener);
        return builder;
